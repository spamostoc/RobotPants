...
private var controller : MechController;
...
function Awake ()
{
	...
	if (_target)
	{
		controller = _target.GetComponent(MechController);
	}
	...
	if (controller)
	{
		...
		Debug.Log("Please assign a target to the camera that has a MechController script attached.");
